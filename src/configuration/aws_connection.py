import boto3 # Helps us to work and connecting with AWS
import os
...
class S3Client:
    ...
    def __init__(self, region_name=REGION_NAME):
        """
        This class gets aws credentials from env_variable and creates a connection with 
        s3 bucket and raise exception when environment variable is not set
        """
