...
class DataValidation:
    ...
    def is_column_exist(self, df:DataFrame) -> bool:
        """
        Method Name: is column_exist
        Description: This method validates the existance of a numerical and categorical columns

        Output: Returns boolean value based on validation results
        On Failure: Write an exception log and then raise an exception
        """
        try:
            ...
            if len(missing_categorical_columns) > 0:
                logging.info(f"Missing categorical column: {missing_numerical_columns}")
